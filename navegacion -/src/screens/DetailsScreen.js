...
export default function DetailsScreen() {
  ...
  const [projects, setProjects] = useState([
    { id: '1', name: 'Proyecto 1', manager: 'Juan Pérez', contact: 'juan.perez@example.com', socialMedia: ['facebook', 'x'] },
    { id: '2', name: 'Proyecto 2', manager: 'María González', contact: 'maria.gonzalez@example.com', socialMedia: ['instagram', 'linkedin'] },
    { id: '3', name: 'Proyecto 3', manager: 'Carlos Martínez', contact: 'carlos.martinez@example.com', socialMedia: ['x', 'linkedin'] },
  ]);
